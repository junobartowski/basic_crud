...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php $attributes = array('id' => 'add_form'); ?>
            <?php echo form_open_multipart('dashboard/page/add', $attributes); ?>
            <h5>URL</h5>
            <input type="text" name="txt_url" class="form-control" value="<?= set_value('txt_url') ?>" size="50" />
            <h5>Name</h5>
            <input type="text" name="txt_name" class="form-control" value="<?= set_value('txt_name') ?>" size="50" />
            <h5>Title</h5>
            <input type="text" name="txt_title" class="form-control" value="<?= set_value('txt_title') ?>" size="50" />
            <h5>Content</h5>
            <textarea class="form-control" id="summernote" name="txt_area_content"><?= set_value('txt_area_content') ?></textarea>
            <br />
            <h4>Picture</h4>
            <h5>*Leave blank if you do not wish to upload</h5>
            ...
            <br />
            <div>
                <input type="button" value="Save" class="btn btn-success" onclick="return submit_add_form();" />
